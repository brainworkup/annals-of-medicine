...
#     orcid: XXXX0009-0007-1967-8304
#     affiliations:
#       - name: USC
#   - name: Brad peterson
#     email: brad@med.usc.edu
#     orcid: XXXX0009-0007-1967-8304
#     affiliations:
#       - name: USC, CHLA
# abstract: |
...
#     include-in-header:
#       - text: '#import "@preview/mitex:0.2.5": *'
# brand: 
#   typography:
#     fonts:
#       - family: Jost
...
format:
  ...
  hikmah-manuscript-pdf: 
    ...
    # APA-related things
    left-aligned: true  # Disable justification
    # Use endnotes; you also need to put \theendnotes somewhere 
